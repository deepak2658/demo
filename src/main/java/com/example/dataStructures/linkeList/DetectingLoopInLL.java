...
import java.util.*;
    //There are two more methods to check a loop
    //1)By changing class Node i.e., by adding a flag into  the class Node so that if visited turns true
...
class DeletingLoopinLL {
    ...
    {
        DeletingLoopinLL llist  = new DeletingLoopinLL();
